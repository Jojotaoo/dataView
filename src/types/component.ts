...
export const DEFAULT_CHART_STYLE: ChartStyleConfig = {
  ...
  series: {
    ...
    mapLabelShow: false, mapLabelColor: '#cdd6f4', mapLabelFontSize: 11,
    mapVisualMin: 0, mapVisualMax: 200, mapVisualColors: ['#313244', '#89b4fa'],
    mapVisualMapShow: false,     mapMarkPointShow: true, mapMarkPointSymbolSize: 12,
    ...
    mapSelectBorderColor: '#00c8ff', mapSelectBorderWidth: 2, mapSelectShadowBlur: 23, mapSelectShadowColor: 'rgba(0,200,255,1)',
    mapHoverBorderColor: '#40b0ff', mapHoverBorderWidth: 3, mapHoverShadowBlur: 30, mapHoverShadowColor: 'rgba(0,200,255,0.3)',
